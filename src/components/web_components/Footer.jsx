...
const Footer = () => {
  ...
  <aside className="items-center grid-flow-col">
    ...
    <nav className='flex gap-4'>
      <a href={credentials.gitHub}><FaGithub  className='w-8 h-8'/></a>
      <a href={credentials.gitLab}><FaGitlab  className='w-8 h-8'/></a>
      <a href={credentials.linkedIn}><FaLinkedin  className='w-8 h-8'/></a>
    </nav>
</footer>
  )
}
